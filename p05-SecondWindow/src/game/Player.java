...
/*
    return jtfName;
/**/
    return jtfName.substring(0, 1).toUpperCase() + jtfName.substring(1).toLowerCase();
  }
...
/*
    return jtfSurname;
/**/
    return jtfSurname.substring(0, 1).toUpperCase() + jtfSurname.substring(1).toLowerCase();
  }
